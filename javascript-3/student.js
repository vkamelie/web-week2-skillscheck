...
groceries.splice(groceries.lenght -1, 1)
displayData()
}
...
function checkGroceryCount(){
    if(groceries.lenght >= 5){
    return 'That looks like a big trip'
    } if(groceries.lenght === 1){
        return '1 item'
    }else if(groceries.lenght >= 1 && groceries.lenght <= 5)
    return groceries.lenght + " Items"
}
//////////////////STEP 6////////////////////
